...
Last verified: 2026-07-24 on the current worktree for Decision Interview routing, trigger narrowing, risk-triggered direction exploration, Product Reality Check, Style Evidence Check, and correction-loop routing.
...
- `noootwo-product` `v0.5.0` owns Decision Interview, Product Discovery, Product Checkpoint, Product Reality Check, Product Choice Challenge, product decision-layer diagnosis, and Product-to-Design Handoff. Decision Interview asks one material product question at a time after discoverable facts are checked.
...
- `noootwo-workflow` `v0.7.5` routes unclear product paths and multi-question product ambiguity to Product Decision Interview, routes repeated correction loops back to Product Reality Check or Style Evidence Check, and passes Product-to-Design Handoff to Design for non-quick UI work.
...
- Decision Interview must not become a fixed questionnaire or default ceremony for small code fixes, quick UI polish, or docs tweaks.
