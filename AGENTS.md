...
- Use `$noootwo-workflow` for multi-step AI development workflow, task routing, planning, release sequencing, and keeping work controlled.
- Use `$noootwo-docs` for README, AGENTS, docs/status, ADRs, guides, reference docs, release notes, and documentation hygiene.
- Use `$noootwo-review` for code quality, maintainability, refactoring discipline, test strategy, and implementation review.
