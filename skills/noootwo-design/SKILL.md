...
Read [color-system-calibration.md](references/color-system-calibration.md) only when the task involves cheap/generic color feel, brand token systems, neutral ramps, dark mode, semantic colors, shadows, gradients, icon color drift, illustration color drift, or color accessibility.
