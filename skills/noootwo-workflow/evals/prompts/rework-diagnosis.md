...
- Product understanding routes to `noootwo-product`; wrong visual direction routes to `noootwo-design`; right intent with wrong execution routes to the design detail pass or `noootwo-code-health`.
